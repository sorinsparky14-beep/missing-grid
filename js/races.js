...
const RACE_STORIES = {
  ...
  'japan_1976': {
    text: `Rain hammered Mount Fuji as the grid assembled for what would become one of the most emotionally charged season finales in motorsport. Niki Lauda, who had miraculously survived a near-fatal fireball at the Nürburgring just weeks earlier, climbed into his Ferrari and made two laps before pulling into the pits. The conditions were undriveable, he said. More importantly, he valued his life more than a championship. James Hunt, meanwhile, fought through the chaos, finishing third — just enough to snatch the title by a single point. The contrast between the two men could not have been greater. One chose survival. The other chose glory. Both were right.`,
    tags: ["Title decider", "Drama", "Lauda vs Hunt"]
  },
  'australia_1994': {
    text: `The 1994 season had already been scarred by tragedy. By the time the circus arrived in Adelaide for the final race, Damon Hill trailed Michael Schumacher by a single point. The tension was unbearable. Then, late in the race, Schumacher nudged the wall and Hill moved to pass. The two collided. Schumacher's car was beached on the gravel; Hill's was too damaged to continue. Schumacher became world champion. Whether it was a racing incident or something more deliberate has never been settled — but the debate has never really stopped either. Adelaide 1994 remains F1's great unsolved mystery.`,
  ...
  'monza_1953': {
    text: `In an age before aerodynamics, before carbon fibre, before chicanes, the old Monza circuit was a place of extraordinary speed and genuine danger. In 1953, Fangio, Farina and Ascari arrived at the final lap separated by nothing. Their cars were sliding, screaming machines with barely any of the safety features that would come to define later decades. Fangio found the gap and crossed the line first, with his front bodywork nearly torn free. It was a reminder that motor racing was built on courage first and everything else second — and that Fangio was the most courageous of them all.`,
    tags: ["Pure spectacle", "Classic era battle"]
  },
  'abu_dhabi_2010': {
    text: `Four drivers arrived in Abu Dhabi with a mathematical chance of winning the 2010 world championship. By the end of the afternoon, only one was celebrating. Fernando Alonso, who needed only to finish ahead of Vettel, found himself trapped behind the Renault of Vitaly Petrov — unable to pass, watching the championship slip away. Vettel won the race and the title, becoming the youngest Formula 1 world champion in history at just 23 years old. The records would keep falling. But this was the night they started — in the desert, in the dark, under floodlights, with a German prodigy who had only just begun.`,
    tags: ["Title decider", "Youngest champion ever"]
  },
  'monaco_1992': {
    text: `Nigel Mansell led the 1992 Monaco Grand Prix by nearly a minute when a puncture sent him to the pits. Senna, who had been second all afternoon, inherited the lead with just a few laps remaining. Mansell rejoined on fresh tyres and charged. In the final laps he was catching Senna by three seconds a lap. The gap at the flag was 0.2 seconds. Senna had won his fifth Monaco Grand Prix — equalling Graham Hill's record. The race confirmed what everyone already sensed: at Monaco, Senna was not merely competing. He was at home. He was part of the circuit itself.`,
    tags: ["Pure spectacle", "Senna's mystical Monaco"]
  },
  'bahrain_2020': {
    text: `On the opening lap of the 2020 Bahrain Grand Prix, Romain Grosjean's Haas pierced the barrier at 220 km/h and split in two. The fuel ignited immediately, engulfing the cockpit in a fireball. For twenty-eight seconds, the world watched in horror. Then Grosjean climbed out — burned hands, singed eyebrows, but alive. The halo device, widely criticised as ugly and unnecessary when it was introduced in 2018, had saved his life by deflecting the barrier away from his head. Grosjean later said he felt a presence guiding him through the flames. Whatever the explanation, Formula 1 had witnessed a miracle. He raced again three months later.`,
    tags: ["Drama", "Survival miracle"]
  },
  'europe_1997': {
    text: `Michael Schumacher arrived at the final race of 1997 needing only to finish ahead of Jacques Villeneuve to be world champion. When Villeneuve attempted an overtake, Schumacher turned into him deliberately — but the Williams survived the contact and limped to the finish. Schumacher retired. Villeneuve became world champion. The FIA subsequently excluded Schumacher from the entire season's championship results — one of the most severe punishments in the sport's history. It was the day Formula 1 drew a clear line and said: this is not acceptable.`,
    tags: ["Title decider", "Schumacher's deliberate collision"]
  },
  'britain_1985': {
    text: `Nigel Mansell had been trying to win a Formula 1 Grand Prix for six years. He had driven for Lotus, suffered mechanical failures, been overlooked and underestimated. At Brands Hatch in 1985, in front of a partisan British crowd who had adopted him as their own, he finally crossed the line first. He was thirty-two years old. The scenes of celebration — Mansell in tears, the crowd surging forward — were unlike anything the sport had seen in years. It was not just a victory. It was the beginning of something. The lion had finally roared, and British motorsport would never be the same again.`,
    tags: ["Surprise", "Mansell's first ever win"]
  },
  'monza_1971': {
    text: `The 1971 Italian Grand Prix holds a record that will almost certainly never be broken: the closest finish in Formula 1 history. Peter Gethin crossed the line 0.01 seconds ahead of Ronnie Peterson, with three more cars separated by less than half a second. The average race speed was 242 km/h — a record that stood for decades. Five cars, nose to tail, flat out through the banking of old Monza, reaching for the finish line. Gethin, who had never won a Grand Prix before and never would again, found himself standing on the top step of the podium looking slightly bewildered. Nobody blamed him.`,
    tags: ["Pure spectacle", "Closest finish ever"]
  },
  'brazil_2016': {
    text: `The 2016 Brazilian Grand Prix will be remembered primarily for one thing: a nineteen-year-old Max Verstappen driving through a flooded, treacherous Interlagos in a manner that bordered on the supernatural. While multiple experienced drivers spun off the circuit, Verstappen executed overtake after impossible overtake — sideways, on the limit, in conditions of near-zero visibility. He recovered from a spin and still made his way back through the field. Hamilton won the race, and Rosberg claimed the title later that day. But the story of the afternoon was a teenager announcing, with absolute certainty, that the future of Formula 1 belonged to him.`,
    tags: ["Pure spectacle", "Verstappen in the rain"]
  },
  'hungary_2009': {
    text: `Lewis Hamilton started the 2009 Hungarian Grand Prix from tenth place on the grid after receiving a penalty in qualifying. The circuit is notoriously difficult for overtaking. Nobody gave him much chance. What followed was a masterclass in controlled aggression: Hamilton found gaps where none appeared to exist, managed his tyres with precision, and worked his way to the front. He won comfortably. In a season where McLaren were not the fastest car, it was a performance that reminded everyone why Hamilton had been considered a generational talent from the moment he arrived in the sport.`,
    tags: ["Surprise", "Hamilton's comeback drive"]
  },
  'germany_1961': {
    text: `In 1961, the Ferrari Dino was significantly faster than anything else on the grid. At the Nürburgring — a 22-kilometre circuit of terrifying corners, jumps and blind crests — Stirling Moss drove a Lotus that had no business competing with it. Using strategy, local knowledge and an almost incomprehensible level of car control, Moss kept the Ferraris behind him for the entire race. He won by more than three seconds. Those who were there called it the greatest drive they had ever witnessed. Moss never won a world championship title. But performances like this are why many believe he was the greatest driver who ever lived.`,
    tags: ["Surprise", "Greatest drive of all time?"]
  },
  'monaco_1981': {
    text: `Gilles Villeneuve was already known for his refusal to accept defeat before Monaco 1981 — but this race elevated that reputation to something close to legend. After contact with another car, Villeneuve was driving a Ferrari with severe damage, missing bodywork and barely any aerodynamic downforce. He continued regardless, wrestling the broken machine through Monaco's unforgiving barriers lap after lap. He finished third. He had no right to finish at all. Villeneuve once said that second place was merely the first of the losers. On that afternoon, he finished third and won everything that mattered.`,
    tags: ["Pure spectacle", "Villeneuve refuses to quit"]
  },
  'canada_2014': {
    text: `Daniel Ricciardo had been told that a drive-through penalty would end any hope of victory. He served it, rejoined at the back and began his race again. When Nico Rosberg and Lewis Hamilton collided while fighting for the lead, the Australian found himself in contention. He hunted down Sergio Perez in the closing laps and crossed the line first — despite the penalty, despite the setback, despite everything. It was the first of many victories for one of the most naturally gifted and relentlessly cheerful drivers of his generation. Montreal had found its perfect setting for a debut win: chaotic, unexpected and impossible not to smile at.`,
    tags: ["Surprise", "Ricciardo's first win"]
  },
  'monza_1956': {
    text: `Juan Manuel Fangio needed points at Monza to secure the 1956 world championship. When his Ferrari broke down, his young teammate Peter Collins — who was himself in championship contention — pulled into the pits and handed Fangio his car. By doing so, Collins surrendered his own chance of ever becoming world champion that year. Fangio finished second, scored enough points and took the title. Afterwards, he said it was the most moving gesture he had ever experienced in racing. Collins never did win a championship. He was killed in a racing accident two years later. The 1956 Italian Grand Prix is remembered not for who won, but for what a young man gave away.`,
    tags: ["Drama", "Fangio's noble championship"]
  },
  'qatar_2023': {
    text: `The 2023 Qatar Grand Prix was run under sweltering heat that pushed drivers and teams to their absolute physical limits. Several drivers required medical attention after the race as temperatures in the cockpit soared beyond 50 degrees. Max Verstappen claimed victory to extend his dominant championship lead, but the story of the weekend was the conditions — brutal, unforgiving and unlike anything the modern paddock had experienced. It prompted serious questions about scheduling and driver safety in extreme climates. Formula 1 had come to Qatar, and Qatar had made its presence felt.`,
    tags: ["Drama", "Extreme heat"]
  },
  'bahrain_2024': {
    text: `The 2024 season opener in Bahrain confirmed what many had feared and many had hoped: Red Bull and Max Verstappen were still the force to beat. Carlos Sainz, driving with a recently diagnosed appendicitis that would require surgery days later, delivered a performance of extraordinary courage to finish on the podium. Ferrari showed genuine promise. But Verstappen crossed the line first with something to spare, setting the tone for what would follow. The desert had spoken: the new era had begun exactly where the last one left off.`,
    tags: ["Season opener", "Sainz's courage"]
  },
  'sao_paulo_2021': {
    text: `Lewis Hamilton produced one of the greatest drives of his career at Interlagos in 2021. Starting from the back of the grid after a disqualification in qualifying, he fought through the field with breathtaking aggression and precision. His wheel-to-wheel battle with Max Verstappen — who appeared to force Hamilton off the track — had the paddock divided. Hamilton won the race. The title fight, already the most intense in years, was pushed to its absolute limit. Brazil 2021 was the race that showed the championship would go to the final lap of the final race.`,
    tags: ["Pure spectacle", "Hamilton from the back"]
  },
  'monza_2021': {
    text: `The 2021 Italian Grand Prix produced one of the most extraordinary incidents in recent memory. Max Verstappen and Lewis Hamilton collided at the chicane, with Verstappen's Red Bull launching onto Hamilton's Mercedes. The halo — once controversial, now increasingly essential — saved Hamilton from serious injury as Verstappen's wheel came to rest directly above his head. Both drivers retired. The championship battle had become something altogether more physical. Monza had always had a flair for the dramatic. It did not disappoint.`,
    tags: ["Drama", "Verstappen vs Hamilton"]
  },
  'hungary_2021': {
    text: `A chaotic first corner at the Hungaroring saw Valtteri Bottas collected by Lando Norris, triggering a multi-car incident that eliminated several championship contenders. Esteban Ocon, who had started third, inherited the lead and held on for a stunning maiden victory for Alpine. Sebastian Vettel crossed the line second but was subsequently disqualified for a fuel infringement. Fernando Alonso drove a masterclass in defensive racing to hold Hamilton behind him for lap after lap. It was one of those days when everything happened at once — and the result felt almost impossible to believe.`,
    tags: ["Surprise", "Ocon's first win"]
  },
  'monza_2020': {
    text: `The 2020 Italian Grand Prix delivered one of the most unexpected results in years. Pierre Gasly, driving for the junior AlphaTauri team after being demoted from Red Bull the previous year, crossed the line first at Monza in a race turned upside down by safety cars and a bizarre pit lane incident that penalised Lewis Hamilton. It was Gasly's first Grand Prix victory — and a deeply personal redemption story. After the lowest point of his career, he had climbed to the very top. Monza gave him back everything that had been taken away.`,
    tags: ["Surprise", "Gasly's redemption"]
  },
  'sakhir_2020': {
    text: `With Lewis Hamilton sidelined by COVID-19, George Russell stepped into the Mercedes for the Sakhir Grand Prix and drove as though he had been in the car all season. He led the race and looked set for a fairytale debut win — until a pit stop error by the Mercedes crew gave the position away. Russell, who had never scored a podium in his own Williams, was denied by his own team in the cruellest fashion. Sergio Perez inherited the victory — his first in Formula 1. Two storylines, one race: a nearly-man and a deserving champion, separated by one catastrophic moment.`,
