...
const RACES = [
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'REB', fullName:'Hector Rebaque', name:'Hector Rebaque',        team:'Lotus Ford',       color:'#000000' },
      ...
      { abbr:'LAM', fullName:'Jan Lammers', name:'Jan Lammers',        team:'Shadow Ford',      color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'TAK', fullName:'Noritake Takahara', name:'Noritake Takahara',       team:'Surtees Ford',     color:'#888888' },
      ...
      { abbr:'PER', fullName:'Larry Perkins', name:'Larry Perkins',        team:'Brabham Alfa Romeo',color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'LAG', fullName:'Franck Lagorce', name:'Franck Lagorce',        team:'Ligier Renault',   color:'#888888' },
      ...
      { abbr:'DEL', fullName:'Jean-Denis Delétraz', name:'Jean-Denis Delétraz',       team:'Larrousse Ford',   color:'#888888', isDNF: true },
      ...
      { abbr:'SCH', fullName:'Domenico Schiattarella', name:'Domenico Schiattarella',  team:'Simtek Ford',      color:'#888888', isDNF: true },
      { abbr:'KAT', name:'Ukyo Katayama', fullName:'Ukyo Katayama',       team:'Tyrrell Yamaha',   color:'#888888', isDNF: true },
      { abbr:'NOD', fullName:'Hideki Noda', name:'Hideki Noda',           team:'Larrousse Ford',   color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'WIN', fullName:'Manfred Winkelhock', name:'Manfred Winkelhock',     team:'ATS BMW',          color:'#888888', isDNF: true },
      ...
      { abbr:'HES', fullName:'François Hesnault', name:'François Hesnault',       team:'Ligier Renault',   color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'TUE', fullName:'Esteban Tuero', name:'Esteban Tuero',          team:'Minardi Ford',     color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'MAZ', fullName:'Gaston Mazzacane', name:'Gaston Mazzacane',      team:'Minardi Fondmetal',color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'IRW', fullName:'Chris Irwin', name:'Chris Irwin',          team:'BRM',              color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ALL', fullName:'Philippe Alliot', name:'Philippe Alliot',         team:'Larrousse Lamborghini',color:'#888888', isDNF: true },
      { abbr:'MSC', name:'Michael Schumacher', fullName:'Michael Schumacher',     team:'Benetton Ford',    color:'#27F4D2', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ADA', fullName:'Andrea de Adamich', name:'Andrea de Adamich',     team:'McLaren Alfa Romeo',color:'#888888' },
      ...
      { abbr:'EAT', fullName:'George Eaton', name:'George Eaton',          team:'BRM',              color:'#888888', isDNF: true },
      { abbr:'SCH', fullName:'Tim Schenken', name:'Tim Schenken',       team:'De Tomaso Ford',   color:'#888888', isDNF: true },
      ...
      { abbr:'ROD', fullName:'Pedro Rodriguez', name:'Pedro Rodriguez',      team:'BRM',              color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ALB', fullName:'Christijan Albers', name:'Christijan Albers',         team:'Minardi Cosworth', color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'DUM', fullName:'Johnny Dumfries', name:'Johnny Dumfries',       team:'Lotus Renault',    color:'#000000' },
      { abbr:'ARN', name:'René Arnoux', fullName:'René Arnoux',         team:'Ligier Renault',   color:'#888888' },
      { abbr:'ALL', fullName:'Philippe Alliot', name:'Philippe Alliot',         team:'Ligier Renault',   color:'#888888' },
      { abbr:'PAL', fullName:'Jonathan Palmer', name:'Jonathan Palmer',         team:'Zakspeed',         color:'#888888' },
      ...
      { abbr:'BER', fullName:'Allen Berg', name:'Allen Berg',           team:'Osella Alfa Romeo',color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'PIC', fullName:'Charles Pic', name:'Charles Pic',            team:'Marussia Cosworth',color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ROS', fullName:'Ricardo Rosset', name:'Ricardo Rosset',         team:'Footwork Hart',    color:'#888888', isDNF: true },
      { abbr:'KAT', name:'Ukyo Katayama', fullName:'Ukyo Katayama',       team:'Tyrrell Yamaha',   color:'#888888', isDNF: true },
      { abbr:'MSC', name:'Michael Schumacher', fullName:'Michael Schumacher',   team:'Ferrari',          color:'#E8002D', isDNF: true },
      ...
      { abbr:'LAM', fullName:'Pedro Lamy', name:'Pedro Lamy',           team:'Minardi Ford',     color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'WIL', fullName:'Justin Wilson', name:'Justin Wilson',         team:'Minardi Cosworth', color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'WIN', fullName:'Manfred Winkelhock', name:'Manfred Winkelhock',     team:'ATS Ford',         color:'#888888', isDNF: true },
      ...
      { abbr:'SAL', fullName:'Eliseo Salazar', name:'Eliseo Salazar',        team:'ATS Ford',         color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'DAM', fullName:"Jérôme d'Ambrosio", name:"Jérôme d'Ambrosio",     team:'Virgin Cosworth',  color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'PAL', fullName:'Jonathan Palmer', name:'Jonathan Palmer',         team:'Tyrrell Ford',     color:'#5E8FAA' },
      ...
      { abbr:'PER', fullName:'Luis Pérez-Sala', name:'Luis Pérez-Sala',     team:'Minardi Ford',     color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'WIN', fullName:'Markus Winkelhock', name:'Markus Winkelhock',     team:'Spyker Ferrari',   color:'#888888', isDNF: true },
      ...
      { abbr:'SPE', fullName:'Scott Speed', name:'Scott Speed',          team:'STR Ferrari',      color:'#5E8FAA', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'GIR', fullName:'Yves Giraud-Cabantous', name:'Yves Giraud-Cabantous',team:'Talbot-Lago',    color:'#888888' },
      { abbr:'ROS', name:'Louis Rosier', fullName:'Louis Rosier',         team:'Talbot-Lago',      color:'#888888' },
      { abbr:'GER', fullName:'Bob Gerard', name:'Bob Gerard',         team:'ERA',              color:'#888888' },
      { abbr:'HAR', name:'Peter Harrison', fullName:'Peter Harrison',       team:'ERA',              color:'#888888' },
      { abbr:'ETA', fullName:'Philippe Étancelin', name:'Philippe Étancelin',      team:'Talbot-Lago',      color:'#888888' },
      { abbr:'HAM', fullName:'Leslie Hampshire', name:'Leslie Hampshire',      team:'Maserati',         color:'#888888' },
      { abbr:'SHA', fullName:'Brian Shawe-Taylor', name:'Brian Shawe-Taylor',   team:'Maserati',         color:'#888888' },
      { abbr:'CLA', fullName:'Johnny Claes', name:'Johnny Claes',          team:'Talbot-Lago',      color:'#888888' },
      { abbr:'FAN', name:'Juan Manuel Fangio', fullName:'Juan Manuel Fangio',         team:'Alfa Romeo',       color:'#C92D4B', isDNF: true },
      { abbr:'KEL', fullName:'Joe Kelly', name:'Joe Kelly',          team:'Alta',             color:'#888888', isDNF: true },
      { abbr:'BIR', fullName:'Prince Bira', name:'Prince Bira',           team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'MUR', fullName:'David Murray', name:'David Murray',         team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'CRO', fullName:'Geoffrey Crossley', name:'Geoffrey Crossley',       team:'Alta',             color:'#888888', isDNF: true },
      { abbr:'GRA', name:'Emmanuel de Graffenried', fullName:'Emmanuel de Graffenried', team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'CHI', fullName:'Louis Chiron', name:'Louis Chiron',         team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'MAR', fullName:'Eugene Martin', name:'Eugene Martin',         team:'Talbot-Lago',      color:'#888888', isDNF: true },
      { abbr:'ROL', fullName:'Tony Rolt', name:'Tony Rolt',           team:'ERA',              color:'#888888', isDNF: true },
      { abbr:'JOH', fullName:'Leslie Johnson', name:'Leslie Johnson',        team:'ERA',              color:'#888888', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'RAI', name:'Kimi Räikkönen', fullName:'Kimi Räikkönen',      team:'Ferrari',          color:'#E8002D', isDNF: true },
      { abbr:'PAL', fullName:'Jolyon Palmer', name:'Jolyon Palmer',         team:'Renault',          color:'#FFD800', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'TAK', fullName:'Noritake Takahara', name:'Noritake Takahara',      team:'Tyrrell Ford',     color:'#5E8FAA' },
      ...
      { abbr:'TAK2', fullName:'Kunimitsu Takahashi',name:'Kunimitsu Takahashi',       team:'Kojima Ford',      color:'#888888', isDNF: true },
      { abbr:'AND', name:'Mario Andretti', fullName:'Mario Andretti',       team:'Lotus Ford',       color:'#000000', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'BAU', fullName:'Zsolt Baumgartner', name:'Zsolt Baumgartner',    team:'Minardi Cosworth', color:'#888888' },
      ...
      { abbr:'BRU', fullName:'Gianmaria Bruni', name:'Gianmaria Bruni',          team:'Minardi Cosworth', color:'#888888', isDNF: true },
      { abbr:'PAN2', fullName:'Giorgio Pantano',name:'Giorgio Pantano',        team:'Jordan Ford',      color:'#888888', isDNF: true },
      { abbr:'WEB', name:'Mark Webber', fullName:'Mark Webber',         team:'Jaguar Cosworth',  color:'#229971', isDNF: true },
      { abbr:'SAT', name:'Takuma Sato', fullName:'Takuma Sato',           team:'BAR Honda',        color:'#888888', isDNF: true },
      { abbr:'COU', name:'David Coulthard', fullName:'David Coulthard',      team:'McLaren Mercedes', color:'#27F4D2', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'MIE', fullName:'Roberto Mieres', name:'Roberto Mieres',         team:'Gordini',          color:'#888888' },
      ...
      { abbr:'SCH', fullName:'Harry Schell', name:'Harry Schell',         team:'Gordini',          color:'#888888' },
      { abbr:'CHI', fullName:'Louis Chiron', name:'Louis Chiron',         team:'OSCA',             color:'#888888' },
      { abbr:'BIR', fullName:'Prince Bira', name:'Prince Bira',           team:'Maserati',         color:'#888888' },
      { abbr:'BRO', fullName:'Alan Brown', name:'Alan Brown',          team:'Cooper Bristol',   color:'#888888' },
      ...
      { abbr:'GIR', fullName:'Yves Giraud-Cabantous', name:'Yves Giraud-Cabantous',team:'HWM Alta',       color:'#888888' },
      ...
      { abbr:'MAR', fullName:'Onofre Marimón', name:'Onofre Marimón',        team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'CAR', fullName:'Piero Carini', name:'Piero Carini',         team:'Ferrari',          color:'#E8002D', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'FON', fullName:'Norberto Fontana', name:'Norberto Fontana',        team:'Sauber Petronas',  color:'#888888' },
      { abbr:'MAR', fullName:'Tarso Marques', name:'Tarso Marques',        team:'Minardi Hart',     color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ALL', fullName:'Philippe Alliot', name:'Philippe Alliot',         team:'RAM Hart',         color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'BEU', fullName:'Mike Beuttler', name:'Mike Beuttler',       team:'March Ford',       color:'#888888', isDNF: true },
      { abbr:'PES', name:'Henri Pescarolo', fullName:'Henri Pescarolo',      team:'March Ford',       color:'#888888', isDNF: true },
      { abbr:'ADA', fullName:'Andrea de Adamich', name:'Andrea de Adamich',     team:'March Alfa Romeo', color:'#888888', isDNF: true },
      ...
      { abbr:'GAL', fullName:'Nanni Galli', name:'Nanni Galli',          team:'March Ford',       color:'#888888', isDNF: true },
      { abbr:'MOS', fullName:'Silvio Moser', name:'Silvio Moser',          team:'Bellasi Ford',     color:'#888888', isDNF: true },
      { abbr:'SCH', fullName:'Tim Schenken', name:'Tim Schenken',       team:'Brabham Ford',     color:'#888888', isDNF: true },
      { abbr:'MAR', fullName:'Helmut Marko', name:'Helmut Marko',          team:'BRM',              color:'#888888', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'LEW', fullName:'Jack Lewis', name:'Jack Lewis',          team:'Cooper Climax',    color:'#888888' },
      { abbr:'SAL', fullName:'Roy Salvadori', name:'Roy Salvadori',      team:'Cooper Climax',    color:'#888888' },
      { abbr:'MAG', name:'Tony Maggs', fullName:'Tony Maggs',          team:'Lotus Climax',     color:'#000000' },
      { abbr:'BUR', fullName:'Ian Burgess', name:'Ian Burgess',        team:'Cooper Climax',    color:'#888888' },
      { abbr:'HER', fullName:'Hans Herrmann', name:'Hans Herrmann',       team:'Porsche',          color:'#888888' },
      { abbr:'DEG', fullName:'Carel Godin de Beaufort', name:'Carel Godin de Beaufort',    team:'Porsche',          color:'#888888' },
      { abbr:'MAI', name:'Willy Mairesse', fullName:'Willy Mairesse', team:'Ferrari',          color:'#E8002D', isDNF: true },
      { abbr:'MAR', fullName:'Tony Marsh', name:'Tony Marsh',          team:'Lotus Climax',     color:'#000000' },
      { abbr:'ASH', fullName:'Gerry Ashmore', name:'Gerry Ashmore',        team:'Lotus Climax',     color:'#000000' },
      { abbr:'TRI2',name:'Maurice Trintignant', fullName:'Maurice Trintignant',    team:'Cooper Maserati',  color:'#888888', isDNF: true },
      { abbr:'COL', fullName:'Bernard Collomb', name:'Bernard Collomb',        team:'Cooper Climax',    color:'#888888', isDNF: true },
      ...
      { abbr:'SEI', fullName:'Wolfgang Seidel', name:'Wolfgang Seidel',         team:'Lotus Climax',     color:'#000000', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'PIO', fullName:'Luigi Piotti', name:'Luigi Piotti',         team:'Maserati',         color:'#888888' },
      ...
      { abbr:'SIM', fullName:'André Simon', name:'André Simon',          team:'Gordini',          color:'#888888' },
      { abbr:'GER', fullName:'Gerino Gerini', name:'Gerino Gerini',         team:'Maserati',         color:'#888888' },
      { abbr:'SAL', fullName:'Roy Salvadori', name:'Roy Salvadori',      team:'Maserati',         color:'#888888' },
      ...
      { abbr:'SCH', fullName:'Harry Schell', name:'Harry Schell',         team:'Vanwall',          color:'#888888', isDNF: true },
      { abbr:'TRI', name:'Maurice Trintignant', fullName:'Maurice Trintignant',    team:'Vanwall',          color:'#888888', isDNF: true },
      { abbr:'TAR', fullName:'Piero Taruffi', name:'Piero Taruffi',        team:'Vanwall',          color:'#888888', isDNF: true },
      { abbr:'BON', name:'Jo Bonnier', fullName:'Jo Bonnier',        team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'HAL', fullName:'Bruce Halford', name:'Bruce Halford',        team:'Maserati',         color:'#888888', isDNF: true },
      ...
      { abbr:'LES', fullName:'Les Leston', name:'Les Leston',         team:'Connaught Alta',   color:'#888888', isDNF: true },
      { abbr:'SIL', fullName:'Hernando da Silva Ramos', name:'Hernando da Silva Ramos', team:'Gordini',          color:'#888888', isDNF: true },
    ]
  },
...
const RACES = [
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'FIT', name:'Fittipaldi', fullName:'Pietro Fittipaldi',   team:'Haas Ferrari',           color:'#B6BABD' },
      { abbr:'LAT', name:'Latifi', fullName:'Nicholas Latifi',       team:'Williams Mercedes',      color:'#64C4FF', isDNF: true },
      { abbr:'VER', name:'Verstappen', fullName:'Max Verstappen',   team:'Red Bull Racing Honda',  color:'#3671C6', isDNF: true },
      { abbr:'LEC', name:'Leclerc', fullName:'Charles Leclerc',      team:'Ferrari',                color:'#E8002D', isDNF: true },
    ]
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'VIL', name:'Villeneuve', fullName:'Gilles Villeneuve',     team:'Ferrari',          color:'#E8002D' },
      ...
      { abbr:'ROS', name:'Rosberg', fullName:'Keke Rosberg',        team:'Wolf Ford',        color:'#888888' },
      ...
      { abbr:'REB', fullName:'Hector Rebaque', name:'Rebaque',        team:'Lotus Ford',       color:'#000000' },
      ...
      { abbr:'LAM', fullName:'Jan Lammers', name:'Lammers',        team:'Shadow Ford',      color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'TAK', fullName:'Noritake Takahara', name:'Takahara',       team:'Surtees Ford',     color:'#888888' },
      ...
      { abbr:'PER', fullName:'Larry Perkins', name:'Perkins',        team:'Brabham Alfa Romeo',color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'LAG', fullName:'Franck Lagorce', name:'Lagorce',        team:'Ligier Renault',   color:'#888888' },
      ...
      { abbr:'DEL', fullName:'Jean-Denis Delétraz', name:'Deletraz',       team:'Larrousse Ford',   color:'#888888', isDNF: true },
      ...
      { abbr:'MSC', name:'Schumacher', fullName:'Michael Schumacher',     team:'Benetton Ford',    color:'#27F4D2', isDNF: true },
      { abbr:'HIL', name:'Hill', fullName:'Damon Hill',           team:'Williams Renault', color:'#64C4FF', isDNF: true },
      { abbr:'SCH', fullName:'Domenico Schiattarella', name:'Schiattarella',  team:'Simtek Ford',      color:'#888888', isDNF: true },
      { abbr:'KAT', name:'Katayama', fullName:'Ukyo Katayama',       team:'Tyrrell Yamaha',   color:'#888888', isDNF: true },
      { abbr:'NOD', fullName:'Hideki Noda', name:'Noda',           team:'Larrousse Ford',   color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'NAK', name:'Nakajima', fullName:'Kazuki Nakajima',       team:'Williams Toyota',  color:'#64C4FF' },
      { abbr:'FIS', name:'Fisichella', fullName:'Giancarlo Fisichella',     team:'Force India Ferrari',color:'#FF87BC' },
      { abbr:'PIQ', name:'Piquet', fullName:'Nelson Piquet Jr.',         team:'Renault',          color:'#FFD800', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'SEN', name:'Senna', fullName:'Ayrton Senna',          team:'Toleman Hart',     color:'#888888' },
      { abbr:'ARN', name:'Arnoux', fullName:'René Arnoux',         team:'Ferrari',          color:'#E8002D' },
      { abbr:'ROS', name:'Rosberg', fullName:'Keke Rosberg',        team:'Williams Honda',   color:'#64C4FF' },
      ...
      { abbr:'WIN', fullName:'Manfred Winkelhock', name:'Winkelhock',     team:'ATS BMW',          color:'#888888', isDNF: true },
      ...
      { abbr:'HES', fullName:'François Hesnault', name:'Hesnault',       team:'Ligier Renault',   color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'TUE', fullName:'Esteban Tuero', name:'Tuero',          team:'Minardi Ford',     color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'MAZ', fullName:'Gaston Mazzacane', name:'Mazzacane',      team:'Minardi Fondmetal',color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'IRW', fullName:'Chris Irwin', name:'Irwin',          team:'BRM',              color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    hidden: [1, 3, 5, 8, 11],
    drivers: [
      { abbr:'SEN', name:'Senna', fullName:'Ayrton Senna',          team:'McLaren Ford',     color:'#FF8000' },
      ...
      { abbr:'ALL', fullName:'Philippe Alliot', name:'Alliot',         team:'Larrousse Lamborghini',color:'#888888', isDNF: true },
      { abbr:'MSC', name:'Schumacher', fullName:'Michael Schumacher',     team:'Benetton Ford',    color:'#27F4D2', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ADA', fullName:'Andrea de Adamich', name:'de Adamich',     team:'McLaren Alfa Romeo',color:'#888888' },
      ...
      { abbr:'EAT', fullName:'George Eaton', name:'Eaton',          team:'BRM',              color:'#888888', isDNF: true },
      { abbr:'SCH', fullName:'Tim Schenken', name:'Schenken',       team:'De Tomaso Ford',   color:'#888888', isDNF: true },
      ...
      { abbr:'ROD', fullName:'Pedro Rodriguez', name:'Rodriguez',      team:'BRM',              color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ALB', fullName:'Christijan Albers', name:'Albers',         team:'Minardi Cosworth', color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'DUM', fullName:'Johnny Dumfries', name:'Dumfries',       team:'Lotus Renault',    color:'#000000' },
      { abbr:'ARN', name:'Arnoux', fullName:'René Arnoux',         team:'Ligier Renault',   color:'#888888' },
      { abbr:'ALL', fullName:'Philippe Alliot', name:'Alliot',         team:'Ligier Renault',   color:'#888888' },
      { abbr:'PAL', fullName:'Jonathan Palmer', name:'Palmer',         team:'Zakspeed',         color:'#888888' },
      ...
      { abbr:'ROS', name:'Rosberg', fullName:'Keke Rosberg',        team:'McLaren TAG',      color:'#FF8000', isDNF: true },
      { abbr:'BER', fullName:'Allen Berg', name:'Berg',           team:'Osella Alfa Romeo',color:'#888888', isDNF: true },
      ...
      { abbr:'SEN', name:'Senna', fullName:'Ayrton Senna',          team:'Lotus Renault',    color:'#000000', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'MSC', name:'Schumacher', fullName:'Michael Schumacher',     team:'Mercedes',         color:'#27F4D2' },
      ...
      { abbr:'PIC', fullName:'Charles Pic', name:'Pic',            team:'Marussia Cosworth',color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ROS', fullName:'Ricardo Rosset', name:'Rosset',         team:'Footwork Hart',    color:'#888888', isDNF: true },
      { abbr:'KAT', name:'Katayama', fullName:'Ukyo Katayama',       team:'Tyrrell Yamaha',   color:'#888888', isDNF: true },
      { abbr:'MSC', name:'M.Schumacher', fullName:'Michael Schumacher',   team:'Ferrari',          color:'#E8002D', isDNF: true },
      ...
      { abbr:'LAM', fullName:'Pedro Lamy', name:'Lamy',           team:'Minardi Ford',     color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'WIL', fullName:'Justin Wilson', name:'Wilson',         team:'Minardi Cosworth', color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'ROS', name:'Rosberg', fullName:'Keke Rosberg',        team:'Williams Ford',    color:'#64C4FF', isDNF: true },
      ...
      { abbr:'WIN', fullName:'Manfred Winkelhock', name:'Winkelhock',     team:'ATS Ford',         color:'#888888', isDNF: true },
      ...
      { abbr:'SAL', fullName:'Eliseo Salazar', name:'Salazar',        team:'ATS Ford',         color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    hidden: [1, 3, 5, 7],
    drivers: [
      { abbr:'SEN', name:'Senna', fullName:'Ayrton Senna',          team:'McLaren Honda',    color:'#FF8000' },
      ...
      { abbr:'PAL', fullName:'Jonathan Palmer', name:'Palmer',         team:'Tyrrell Ford',     color:'#5E8FAA' },
      ...
      { abbr:'PER', fullName:'Luis Pérez-Sala', name:'Perez-Sala',     team:'Minardi Ford',     color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'WIN', fullName:'Markus Winkelhock', name:'Winkelhock',     team:'Spyker Ferrari',   color:'#888888', isDNF: true },
      ...
      { abbr:'SPE', fullName:'Scott Speed', name:'Speed',          team:'STR Ferrari',      color:'#5E8FAA', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'GIR', fullName:'Yves Giraud-Cabantous', name:'Giraud-Cabantous',team:'Talbot-Lago',    color:'#888888' },
      { abbr:'ROS', name:'Rosier', fullName:'Louis Rosier',         team:'Talbot-Lago',      color:'#888888' },
      { abbr:'GER', fullName:'Bob Gerard', name:'Gerard',         team:'ERA',              color:'#888888' },
      { abbr:'HAR', name:'Harrison', fullName:'Peter Harrison',       team:'ERA',              color:'#888888' },
      { abbr:'ETA', fullName:'Philippe Étancelin', name:'Etancelin',      team:'Talbot-Lago',      color:'#888888' },
      { abbr:'HAM', fullName:'Leslie Hampshire', name:'Hampshire',      team:'Maserati',         color:'#888888' },
      { abbr:'SHA', fullName:'Brian Shawe-Taylor', name:'Shawe-Taylor',   team:'Maserati',         color:'#888888' },
      { abbr:'CLA', fullName:'Johnny Claes', name:'Claes',          team:'Talbot-Lago',      color:'#888888' },
      { abbr:'FAN', name:'Fangio', fullName:'Juan Manuel Fangio',         team:'Alfa Romeo',       color:'#C92D4B', isDNF: true },
      { abbr:'KEL', fullName:'Joe Kelly', name:'Kelly',          team:'Alta',             color:'#888888', isDNF: true },
      { abbr:'BIR', fullName:'Prince Bira', name:'Bira',           team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'MUR', fullName:'David Murray', name:'Murray',         team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'CRO', fullName:'Geoffrey Crossley', name:'Crossley',       team:'Alta',             color:'#888888', isDNF: true },
      { abbr:'GRA', name:'de Graffenried', fullName:'Emmanuel de Graffenried', team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'CHI', fullName:'Louis Chiron', name:'Chiron',         team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'MAR', fullName:'Eugene Martin', name:'Martin',         team:'Talbot-Lago',      color:'#888888', isDNF: true },
      { abbr:'ROL', fullName:'Tony Rolt', name:'Rolt',           team:'ERA',              color:'#888888', isDNF: true },
      { abbr:'JOH', fullName:'Leslie Johnson', name:'Johnson',        team:'ERA',              color:'#888888', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'RAI', name:'Räikkönen', fullName:'Kimi Räikkönen',      team:'Ferrari',          color:'#E8002D', isDNF: true },
      { abbr:'PAL', fullName:'Jolyon Palmer', name:'Palmer',         team:'Renault',          color:'#FFD800', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'TAK', fullName:'Noritake Takahara', name:'Takahashi',      team:'Tyrrell Ford',     color:'#5E8FAA' },
      ...
      { abbr:'VIL', name:'Villeneuve', fullName:'Gilles Villeneuve',     team:'Ferrari',          color:'#E8002D', isDNF: true },
      ...
      { abbr:'TAK2', fullName:'Kunimitsu Takahashi',name:'Takahara',       team:'Kojima Ford',      color:'#888888', isDNF: true },
      { abbr:'AND', name:'Andretti', fullName:'Mario Andretti',       team:'Lotus Ford',       color:'#000000', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'BAU', fullName:'Zsolt Baumgartner', name:'Baumgartner',    team:'Minardi Cosworth', color:'#888888' },
      ...
      { abbr:'BRU', fullName:'Gianmaria Bruni', name:'Bruni',          team:'Minardi Cosworth', color:'#888888', isDNF: true },
      { abbr:'PAN2', fullName:'Giorgio Pantano',name:'Pantano',        team:'Jordan Ford',      color:'#888888', isDNF: true },
      { abbr:'WEB', name:'Webber', fullName:'Mark Webber',         team:'Jaguar Cosworth',  color:'#229971', isDNF: true },
      { abbr:'SAT', name:'Sato', fullName:'Takuma Sato',           team:'BAR Honda',        color:'#888888', isDNF: true },
      { abbr:'COU', name:'Coulthard', fullName:'David Coulthard',      team:'McLaren Mercedes', color:'#27F4D2', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'MIE', fullName:'Roberto Mieres', name:'Mieres',         team:'Gordini',          color:'#888888' },
      ...
      { abbr:'SCH', fullName:'Harry Schell', name:'Schell',         team:'Gordini',          color:'#888888' },
      { abbr:'CHI', fullName:'Louis Chiron', name:'Chiron',         team:'OSCA',             color:'#888888' },
      { abbr:'BIR', fullName:'Prince Bira', name:'Bira',           team:'Maserati',         color:'#888888' },
      { abbr:'BRO', fullName:'Alan Brown', name:'Brown',          team:'Cooper Bristol',   color:'#888888' },
      ...
      { abbr:'GIR', fullName:'Yves Giraud-Cabantous', name:'Giraud-Cabantous',team:'HWM Alta',       color:'#888888' },
      ...
      { abbr:'MAR', fullName:'Onofre Marimón', name:'Marimon',        team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'CAR', fullName:'Piero Carini', name:'Carini',         team:'Ferrari',          color:'#E8002D', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'MSC', name:'Schumacher', fullName:'Michael Schumacher',     team:'Mercedes',         color:'#27F4D2', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'MSC', name:'Schumacher', fullName:'Michael Schumacher',     team:'Benetton Ford',    color:'#27F4D2' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'FON', fullName:'Norberto Fontana', name:'Fontana',        team:'Sauber Petronas',  color:'#888888' },
      { abbr:'MAR', fullName:'Tarso Marques', name:'Marques',        team:'Minardi Hart',     color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'SEN', name:'Senna', fullName:'Ayrton Senna',          team:'Lotus Renault',    color:'#000000' },
      { abbr:'ROS', name:'Rosberg', fullName:'Keke Rosberg',        team:'Williams Honda',   color:'#64C4FF' },
      { abbr:'PRO', name:'Prost', fullName:'Alain Prost',          team:'McLaren TAG',      color:'#FF8000' },
      { abbr:'DEA', name:'de Angelis', fullName:'Elio de Angelis',     team:'Lotus Renault',    color:'#000000' },
      ...
      { abbr:'ALL', fullName:'Philippe Alliot', name:'Alliot',         team:'RAM Hart',         color:'#888888', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'BEU', fullName:'Mike Beuttler', name:'Beuttler',       team:'March Ford',       color:'#888888', isDNF: true },
      { abbr:'PES', name:'Pescarolo', fullName:'Henri Pescarolo',      team:'March Ford',       color:'#888888', isDNF: true },
      { abbr:'ADA', fullName:'Andrea de Adamich', name:'de Adamich',     team:'March Alfa Romeo', color:'#888888', isDNF: true },
      ...
      { abbr:'GAL', fullName:'Nanni Galli', name:'Galli',          team:'March Ford',       color:'#888888', isDNF: true },
      { abbr:'MOS', fullName:'Silvio Moser', name:'Moser',          team:'Bellasi Ford',     color:'#888888', isDNF: true },
      { abbr:'SCH', fullName:'Tim Schenken', name:'Schenken',       team:'Brabham Ford',     color:'#888888', isDNF: true },
      { abbr:'MAR', fullName:'Helmut Marko', name:'Marko',          team:'BRM',              color:'#888888', isDNF: true },
    ]
  },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'HEI', name:'Heidfeld', fullName:'Nick Heidfeld',       team:'Sauber BMW',       color:'#888888' },
      { abbr:'PIQ', name:'Piquet', fullName:'Nelson Piquet Jr.',         team:'Renault',          color:'#FFD800' },
      { abbr:'KUB', name:'Kubica', fullName:'Robert Kubica',         team:'Sauber BMW',       color:'#888888' },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'LEW', fullName:'Jack Lewis', name:'Lewis',          team:'Cooper Climax',    color:'#888888' },
      { abbr:'SAL', fullName:'Roy Salvadori', name:'Salvadori',      team:'Cooper Climax',    color:'#888888' },
      { abbr:'MAG', name:'Maggs', fullName:'Tony Maggs',          team:'Lotus Climax',     color:'#000000' },
      { abbr:'BUR', fullName:'Ian Burgess', name:'Burgess',        team:'Cooper Climax',    color:'#888888' },
      { abbr:'HER', fullName:'Hans Herrmann', name:'Herrmann',       team:'Porsche',          color:'#888888' },
      { abbr:'DEG', fullName:'Carel Godin de Beaufort', name:'de Beaufort',    team:'Porsche',          color:'#888888' },
      { abbr:'MAI', name:'Willy Mairesse', fullName:'Willy Mairesse', team:'Ferrari',          color:'#E8002D', isDNF: true },
      { abbr:'MAR', fullName:'Tony Marsh', name:'Marsh',          team:'Lotus Climax',     color:'#000000' },
      { abbr:'ASH', fullName:'Gerry Ashmore', name:'Ashmore',        team:'Lotus Climax',     color:'#000000' },
      { abbr:'TRI2',name:'Trintignant', fullName:'Maurice Trintignant',    team:'Cooper Maserati',  color:'#888888', isDNF: true },
      { abbr:'COL', fullName:'Bernard Collomb', name:'Collomb',        team:'Cooper Climax',    color:'#888888', isDNF: true },
      ...
      { abbr:'SEI', fullName:'Wolfgang Seidel', name:'Seidel',         team:'Lotus Climax',     color:'#000000', isDNF: true },
  ...
  ───────────────────────────────────────── */
  {
    ...
    drivers: [
      ...
      { abbr:'PIO', fullName:'Luigi Piotti', name:'Piotti',         team:'Maserati',         color:'#888888' },
      ...
      { abbr:'SIM', fullName:'André Simon', name:'Simon',          team:'Gordini',          color:'#888888' },
      { abbr:'GER', fullName:'Gerino Gerini', name:'Gerini',         team:'Maserati',         color:'#888888' },
      { abbr:'SAL', fullName:'Roy Salvadori', name:'Salvadori',      team:'Maserati',         color:'#888888' },
      ...
      { abbr:'SCH', fullName:'Harry Schell', name:'Schell',         team:'Vanwall',          color:'#888888', isDNF: true },
      { abbr:'TRI', name:'Trintignant', fullName:'Maurice Trintignant',    team:'Vanwall',          color:'#888888', isDNF: true },
      { abbr:'TAR', fullName:'Piero Taruffi', name:'Taruffi',        team:'Vanwall',          color:'#888888', isDNF: true },
      { abbr:'BON', name:'Bonnier', fullName:'Jo Bonnier',        team:'Maserati',         color:'#888888', isDNF: true },
      { abbr:'HAL', fullName:'Bruce Halford', name:'Halford',        team:'Maserati',         color:'#888888', isDNF: true },
      ...
      { abbr:'LES', fullName:'Les Leston', name:'Leston',         team:'Connaught Alta',   color:'#888888', isDNF: true },
      { abbr:'SIL', fullName:'Hernando da Silva Ramos', name:'da Silva Ramos', team:'Gordini',          color:'#888888', isDNF: true },
    ]
  },
